Emplaitress {
    ...
    *initClass {
        ...
        StartUp.add {
            ...
            SynthDef(\plaitsADSR, {
                |out, pitch=60.0, engine=0, harm=0.1, timbre=0.5, morph=0.5, fm_mod=0.0, timb_mod=0.0,
	    	        morph_mod=0.0, attack=0.1, decay=0.5, sustain=0.5, release=0.5, lpg_color=0.5, mul=1.0, aux_mix=0.0, gain=1.0, pan=0.0, gate=1|
	    	    ...
	    	    sound = (gain*sound).softclip;
	    	    DetectSilence.ar(sound, time: 0.2, doneAction: Done.freeSelf);
	    	    Out.ar(out, Pan2.ar(sound, pan));
	        }).add;	        
